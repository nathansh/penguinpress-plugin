...
function pp_admin_js() {
	wp_enqueue_script('pp_admin',  plugin_dir_url(SITE_PLUGIN_NAME . '/' . SITE_PLUGIN_NAME . '.php') . 'js/' . SITE_PLUGIN_NAME . '.js', array('jquery'), '1.0', true);
}

//add_action('admin_init', 'pp_admin_style');
...
//add_action('admin_menu', 'pp_remove_menus', 999);
...
//add_action( 'admin_bar_menu', 'pp_remove_wp_nodes', 999 );
